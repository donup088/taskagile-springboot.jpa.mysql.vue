...
public class ApiResult extends HashMap<String, Object> {
    ...
    public static ApiResult error(String message, String errorReferenceCode) {
        hasText(message, "Parameter `message` must not be blank");
        hasText(errorReferenceCode, "Parameter `errorReferenceCode` must not be blank");
    ...
    public ApiResult add(String key, Object value) {
        hasText(key, "Parameter `key` must not be blank");
        notNull(value, "Parameter `value` must not be null");
